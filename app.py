...
try:
    ...
    print(movies_list_df.head())  # Print the first few rows to confirm data loading
...
mood_keywords = {
    'happy': ['comedy', 'drama', 'family', 'musical'],
    'sad': ['drama', 'tragedy', 'war'],
    'excited': ['action', 'thriller', 'sci-fi', 'crime'],
    'romantic': ['romance',  'love'],
    'adventurous': ['adventure', 'fantasy', 'sci-fi', 'action'],
    'motivational': ['biography', 'sports', 'inspirational', 'documentary'],
    'horror': ['horror']
}

@app.route('/', methods=['GET'])
def index():
    # Ensure that movies_list_df is not empty
